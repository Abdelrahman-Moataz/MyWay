...
class AnimatedDialogFast10 extends StatefulWidget {
  final double height;
  final double width;

  const AnimatedDialogFast10({Key? key, required this.height, required this.width})
      : super(key: key);

  @override
  State<AnimatedDialogFast10> createState() => _AnimatedDialogFast10State();
}

class _AnimatedDialogFast10State extends State<AnimatedDialogFast10> {
